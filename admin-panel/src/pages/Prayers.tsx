...
const Prayers: React.FC = () => {
  ...
  const handleSubmit = async () => {
    try {
      if (selectedPrayer) {
        const updatedPrayer = await prayerService.updatePrayer(selectedPrayer._id, formData);
        ...
        const newPrayer = await prayerService.createPrayer(formData as CreatePrayerData);
        console.log('Prayer created:', newPrayer);
        setSnackbar({
          open: true,
